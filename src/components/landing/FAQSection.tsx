...
const FAQ_ITEMS = [
  {
    q: 'Fleety는 어떤 서비스인가요?',
    a: 'Fleety는 K-뷰티 SME의 수출 오퍼레이션을 자동화하는 B2B SaaS입니다. 무역 서류 자동 생성, 11개국 규제 체크, 바이어 CRM을 하나의 플랫폼에서 제공합니다.',
    category: 'product',
  },
  {
    q: '어떤 나라를 지원하나요?',
  ...
  },
  {
    ...
    a: '일반 LLM은 대화는 잘하지만 조건이 바뀌면 문서 간 일관성이 깨지고, 표/수치 같은 필드 업데이트가 어렵습니다. Fleety는 프로젝트 DB와 템플릿 엔진으로 문서 간 연결을 유지하고, 조건 변경 시 연관 서류를 자동 업데이트합니다.',
    category: 'product',
  },
  {
  ...
  },
  {
    ...
    a: 'Fleety는 법률 자문이 아닌 실무 준비용 도구입니다. RulePack에 관련 법령 출처를 명시하고, 버전 히스토리를 남겨 리스크를 줄입니다. 추후 전문가 검토(관세사/무역사) 유료 옵션이 추가될 예정입니다.',
    category: 'compliance',
  },
  {
